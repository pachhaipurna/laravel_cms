            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card card-primary">
                        ...
                        <form action="<?php echo e(route('save_book')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="card-body">
                                <div class="form-group <?php echo e(($errors->has('title'))?'has-error':''); ?>">
                                    ...
                                    <input type="text" class="form-control" id="title" name="title"
                                           placeholder="Enter book title." value="<?php echo e(old('title')); ?>">
                                ...
                                <div class="form-group <?php echo e(($errors->has('author_name'))?'has-error':''); ?>">
                                    ...
                                    <input type="text" class="form-control" name="author_name" id="author_name"
                                           placeholder="Enter author name." value="<?php echo e(old('author_name')); ?>">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMP\htdocs\Laravel Projects\Yaraku\web-developer-assignment\src\resources\views/assignment/create.blade.php ENDPATH**/ ?>